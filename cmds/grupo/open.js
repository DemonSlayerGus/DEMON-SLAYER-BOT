...
async function ejecutarAccion(sock, chatId) {
  try {
    ...
    await sock.sendMessage(chatId, { text: `🩸 *El grupo ha sido cerrado por Demon Slayer*\nSolo los admins pueden hablar.` })
  } catch(e) {
    ...
    try {
      ...
      if (!args.length) {
        ...
        if (groupAnnouncement === true) {
          ...
          return sock.sendMessage(msg.chat, { text: `✨ *El grupo ha sido abierto por Demon Slayer*\nTodos pueden hablar.` }, { quoted: msg })
        } else {
          return sock.sendMessage(msg.chat, { text: `⚔️ *El grupo ya está abierto por Demon Slayer*` }, { quoted: msg })
        }
      }
      ...
      await sock.groupSettingUpdate(msg.chat, 'not_announcement')
      await sock.sendMessage(msg.chat, { text: `✨ *El grupo ha sido abierto por Demon Slayer*\n⏰ Se cerrará en: *${args[0]}*` }, { quoted: msg })
      await scheduleGroupAction(msg.chat, ms, sock)
    } catch(e) {
      console.log("Error en open:", e)
      return sock.sendMessage(msg.chat, { text: `❌ *Error:* No tengo permisos de admin.` }, { quoted: msg })
    }
  }
}