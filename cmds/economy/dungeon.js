...
export default {
  ...
  category: 'rpg',
    ...
    if (chat.adminonly ||!chat.rpg)
      ...
      return sock.sendMessage(msg.chat, { text: `✎ Debes esperar *${msToTime(restante)}* antes de volver a la mazmorra.` }, { quoted: msg })
      }
   ...
   await db.updateChatUser(msg.chat, msg.sender, 'coins', user.coins) // <-- aqui estaba user.coin
