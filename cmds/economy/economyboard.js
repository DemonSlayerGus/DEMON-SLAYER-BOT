...
export default {
  ...
  if (total >= 1000) {
    ...
    users.push({...data, jid: data.user_id, name })
      ...
      if (users.length === 0)
        return sock.sendMessage(msg.chat, { text: `ꕥ No hay usuarios en el grupo con más de 1,000 ${monedas}.` }, { quoted: msg })
      ...
      if (isNaN(page) || page < 1 || page > totalPages)
        return sock.sendMessage(msg.chat, { text: `《✧》 La página *${page}* no existe. Hay *${totalPages}* páginas.` }, { quoted: msg })
      ...
      await sock.sendMessage(msg.chat, { text: boardText }, { quoted: msg })
    } catch (e) {
