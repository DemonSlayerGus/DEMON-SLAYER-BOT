...
export default {
  ...
  run: async ({ msg, sock, args, command, text, usedPrefix: prefix }) => {
    ...
    if (ranking.length === 0)
      return sock.sendMessage(msg.chat, { text: `「✎」 No hay actividad registrada en los últimos 30 días.` }, { quoted: msg })
    ...
    if (page < 1 || page > totalPages)
      return sock.sendMessage(msg.chat, { text: `「✎」 Página inválida. Solo hay ${totalPages} páginas disponibles.` }, { quoted: msg })
